...
Write-Host "  $(Join-Path $PreviewDir 'geometry_diagnostic_report.json')"
Write-Host "  $(Join-Path $OutputDir 'geometry_diagnostic_report.json')"
Write-Host "  $(Join-Path $OutputDir 'geometry_transform_diff_report.json')"
